...
## Objective
Practice using Git and GitHub to manage a project, track changes, and keep work organized. The goal was to learn how to create and use a repository, connect securely, create branches, stage and commit changes, and synchronize work with GitHub.
...
I generated a new SSH key using `ssh-keygen -t ed25519`, then added it to the keychain with `ssh-add --apple-use-keychain ~/.ssh/id_ed25519`. After confirming the public key was added to GitHub, I tested the connection again with `ssh -T git@github.com`.
